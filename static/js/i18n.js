(function () {
    const dictionaries = {
        fr: {
            ...
            bac_absorption_note: "ℹ️ Le taux monte progressivement : chaque bière est absorbée sur environ 30 min (temps moyen pour boire un verre), et non d'un seul coup.",
        ...
        en: {
            ...
            bac_chart_now: "Now",
            bac_absorption_note: "ℹ️ Your BAC rises gradually: each beer is absorbed over about 30 min (the average time to drink one), not all at once.",
