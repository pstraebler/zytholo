(function () {
    const dictionaries = {
        fr: {
            ...
            stats_first_consumption: "🍺 Première bière enregistrée le {date}",
            stats_beers_per_week: "Par semaine",
            stats_beers_per_month: "Par mois",
            stats_beers_per_year: "Par an",
            stats_beers_unit: "bières",
            ...
            admin_night_mode_on: "🌙 Mode soirée actif",
            admin_night_mode_off: "Mode soirée inactif",
            admin_night_mode_enable: "🌙 Activer",
            admin_night_mode_disable: "🌙 Désactiver",
            delete: "Supprimer",
            ...
            settings_bac_disable_hint: "0 = estimation désactivée",
            ...
            bac_subtitle_today: "Consommation d'aujourd'hui",
            bac_subtitle_day: "Journée du {date}",
            bac_chart_series: "Alcoolémie estimée",
            bac_chart_legal: "Seuil légal",
            bac_chart_now: "Maintenant",
            bac_absorption_note: "ℹ️ Le taux monte progressivement : chaque bière est absorbée sur environ 30 min (temps moyen pour boire un verre).",
            ...
            bac_probation_note: "🔰 Dans certains pays, aucun verre d'alcool n'est autorisé (ex. permis probatoire / jeune conducteur : 0 g/L).",
            ...
            bac_disclaimer_summary: "⚠️ Estimation indicative (formule de Widmark). Elle ne remplace pas un éthylotest.",
            ...
            bac_legal_until_label: "Repassage sous {limit} g/L",
            bac_sober_label: "Retour à 0 g/L",
            bac_clock_at: "vers {time}",
            bac_eta: "dans ~{duration}",
            duration_hm: "{h} h {m}",
            duration_h: "{h} h",
            duration_m: "{m} min",
            save: "Enregistrer",
            ...
            record_peak_bac: "Alcoolémie max {bac} g/L",
            ...
            night_mode_modal_item_1: "Supprimer une bière déjà bue",
            ...
            night_mode_block_decrement: "⚠️ Mode Soirée actif : impossible de supprimer une bière déjà bue 😏",
            ...
            confirm_delete_history: "Êtes-vous sûr de vouloir supprimer cette bière ?",
            error_delete_history: "Erreur lors de la suppression de la bière.",
            ...
            alert_failed_login_title: "🔒 Tentatives de connexion suspectes",
            alert_failed_login_message: "{count} tentatives de connexion échouées détectées sur les {hours} dernières heures.",
            alert_dismiss: "Fermer",
        ...
        en: {
            ...
            stats_first_consumption: "🍺 First beer logged on {date}",
            stats_beers_per_week: "Per week",
            stats_beers_per_month: "Per month",
            stats_beers_per_year: "Per year",
            stats_beers_unit: "beers",
            ...
            admin_night_mode_on: "🌙 Night mode active",
            admin_night_mode_off: "Night mode off",
            admin_night_mode_enable: "🌙 Enable",
            admin_night_mode_disable: "🌙 Disable",
            delete: "Delete",
            ...
            settings_bac_disable_hint: "0 = estimate disabled",
            ...
            bac_subtitle_today: "Today's drinks",
            bac_subtitle_day: "Day of {date}",
            bac_chart_series: "Estimated BAC",
            bac_chart_legal: "Legal limit",
            bac_chart_now: "Now",
            bac_absorption_note: "ℹ️ Your BAC rises gradually: each beer is absorbed over about 30 min (the average time to drink one).",
            ...
            bac_probation_note: "🔰 In some countries, no alcohol at all is allowed (e.g. probationary / novice licence: 0 g/L).",
            bac_disclaimer: "⚠️ Indicative estimate (Widmark formula). It does not replace a breathalyser. When in doubt, do not drive.",
            bac_disclaimer_summary: "⚠️ Indicative estimate (Widmark formula). It does not replace a breathalyser.",
            ...
            bac_legal_until_label: "Back under {limit} g/L",
            bac_sober_label: "Back to 0 g/L",
            bac_clock_at: "around {time}",
            bac_eta: "in ~{duration}",
            duration_hm: "{h}h {m}m",
            duration_h: "{h}h",
            duration_m: "{m} min",
            ...
            record_peak_bac: "Peak BAC {bac} g/L",
            ...
            night_mode_modal_item_1: "Removing an already consumed beer",
            ...
            night_mode_block_decrement: "⚠️ Night mode is active: you cannot remove an already consumed beer 😏",
            ...
            confirm_delete_history: "Are you sure you want to delete this beer?",
            error_delete_history: "Error while deleting the beer.",
            ...
            alert_failed_login_title: "🔒 Suspicious login attempts",
            alert_failed_login_message: "{count} failed login attempts detected in the last {hours} hours.",
